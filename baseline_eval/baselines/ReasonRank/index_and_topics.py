...
r2med_DATASETS = [
    'r2med_Medical-Sciences', 
    'r2med_Biology', 
    'r2med_MedQA-Diag', 
    'r2med_PMC-Clinical', 
    'r2med_Bioinformatics', 
    'r2med_MedXpertQA-Exam', 
    'r2med_PMC-Treatment', 
    'r2med_IIYi-Clinical'
]
...
DOC_MAXLEN = {
    ...
    "r2med_Bioinformatics": 512,
    "r2med_MedXpertQA-Exam": 512,
    "r2med_PMC-Treatment": 512,
    "r2med_IIYi-Clinical": 512,

    # for math data of reasonrank 
    "math-qa": 512,
    "math-theorem": 512,
}
